...
// Composable de tabla
const table = useVuetifyTable<Lugar>({
    apiURL: '/configuracion/lugares',
...
// Composable de CRUD
const crudModal = useCrudModal<Lugar>({
    entityName: 'lugar',
    getPayload: (form) => ({
    ...
    onCreate: async (data: any) => {
        const response = await apiClient.post<Lugar>('/configuracion/lugares', data);
        return response.data;
    },
    onUpdate: async (id: number, data: any) => {
        const response = await apiClient.post<Lugar>(`/configuracion/lugares/${id}`, {
            ...data,
            id,
        });
        return response.data;
    ...
    onDeleteCustom: async (id: number) => {
        await apiClient.delete(`/configuracion/lugares/${id}`);
    },
    onEdit: (lugar: Lugar) => {
...
const downloadExcel = () => {
    table.downloadExcel('lugares.xlsx', 'Lugares');
};
            ...
            <v-card class="mb-4" rounded="lg" elevation="1">
                <v-card-text class="pa-4">
                    <div class="d-flex flex-wrap align-center justify-space-between ga-4">
                        <div>
                            <h1 class="text-h5 font-weight-bold mb-2">Lugares</h1>
