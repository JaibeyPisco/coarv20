...
final class EstudianteUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $estudianteId = is_object($estudiante) ? $estudiante->id : $estudiante;
        ...
        return [
            'dni' => [
                ...
                'string',
                'max:20',
                Rule::unique('estudiante', 'dni')->ignore($estudianteId),
            ],
